{
	...
	const nextMask = document.querySelector(".about-news__nav-mask--right");
	...
	const swiper = new Swiper(".about-news__slider", {
		...
		on: {
			...
			reachEnd: () => {
				nextMask.classList.remove("about-news__nav-mask--visible");
			},
			...
			// // Вся подгрузка новостей закомментирована (бек выводит в слайдер сразу все)
